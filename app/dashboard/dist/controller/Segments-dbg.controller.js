sap.ui.define([
    ...
    function (BaseController, JSONModel, MessageToast, MessageBox) {
        ...
        return BaseController.extend("zdashboard.controller.Segments", {

            /* =========================================================== */
            /* Constants                                                   */
            /* =========================================================== */
            DELETED_TITLE: "XX_DELETED_XX",
            /* =========================================================== */
            /* lifecycle methods                                           */
            /* =========================================================== */
            ...
            onInit: function () {
                ...
                var oViewModel = new JSONModel({
                    busy: true,
                    editable: false,
                    deletedTitle: this.DELETED_TITLE
                });

                this.getRouter().getRoute("segments").attachPatternMatched(this._onRouteMatched, this);

                // Store original busy indicator delay, so it can be restored later on
                var iOriginalBusyDelay = this.getView().getBusyIndicatorDelay();
                this.setModel(oViewModel, "segmentsView");
            ...
            onSearch: function (oEvent) {
                this.byId("idSegmentsTable").rebindTable(true);
            },
             ...
             * @param {sap.ui.base.Event} oEvent 
             */
            onRebindSegmentsTable: function (oEvent) {
                var sSearchQuery = this.byId("_IDSegmentSearchField").getValue();
            ...
            /**
             * Evento chamado ao clicar em Adicionar Segmento
             * @public
             * @param {sap.ui.base.Event} oEvent 
             */
            onAdd: function (oEvent) {
                var oContext = this.getModel().createEntry("/Segments", {
                    properties: {},
                    refreshAfterChange: false
                });
                var oNewColumnListItem = this.byId("idSegmentsColumnListItem").clone();
                oNewColumnListItem.bindElement(oContext.getPath());

                var oTable = this.byId("idSegmentsTable").getTable();
                oTable.addItem(oNewColumnListItem);

                // scrolla até o final da pagina - TODO
                // var oScroll = this.byId("idScrollContainer");
                // jQuery.sap.delayedCall(0, null, function () {
                //     //Scroll to the newly added item
                //     oScroll.scrollToElement(oNewColumnListItem);
                // });
            },

            onDelete: function (oEvent) {
                var sPath = oEvent.getParameter("listItem").getBindingContext().getPath();
                this.getModel().setProperty(sPath + "/Title", this.DELETED_TITLE);
                ...
                this.getModel().submitChanges({
                    success: function (oData) {
                        if (!this.getModel().hasPendingChanges()) {
                            MessageToast.show("Segmentos atualizados com sucesso");
                            this._toggleEdit();
                        }
                    }.bind(this)
                });
            ...
            onConfirm: function (oEvent) {
                ...
                this.getModel("segmentsView").setProperty("/editable", false);
            },
            ...
            _toggleEdit: function (oEvent) {
                var bEditable = !this.getModel("segmentsView").getProperty("/editable");
                this.getModel("segmentsView").setProperty("/editable", bEditable);
            }
